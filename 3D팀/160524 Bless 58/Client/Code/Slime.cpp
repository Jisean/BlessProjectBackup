...
HRESULT CSlime::Initialize(void)
{
...
_int CSlime::Update(const _float& fTimeDelta)
{
...
void CSlime::AniFrameEnd(Engine::ANI_INFO* pData)
{
	//if(!m_bMonster_Wake)
	//{
...
HRESULT CSlime::AddComponent(void)
{
...
void CSlime::Set_ContantTable(LPD3DXEFFECT pEffect)
{
...
{
	CSlime*		pGameObject = new CSlime(pDevice);
...
void CSlime::KeyCheck(void)
{

}

void CSlime::Sound(DWORD dwMyIndex)
{
