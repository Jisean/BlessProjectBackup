...
CS_Skel_Archer::CS_Skel_Archer(LPDIRECT3DDEVICE9 pDevice)
: CMonsters(pDevice)
, m_bPush(false)
//, m_iAniIdx(0)
{
...
CS_Skel_Archer::~CS_Skel_Archer(void)
{

}

HRESULT CS_Skel_Archer::Initialize(void)
{
...
_int CS_Skel_Archer::Update(const _float& fTimeDelta)
{
...
void CS_Skel_Archer::Render(void)
{
...
void CS_Skel_Archer::AniFrameEnd(Engine::ANI_INFO* pData)
{
if(!m_bMonster_Wake)
	{
...
HRESULT CS_Skel_Archer::AddComponent(void)
{
...
void CS_Skel_Archer::Set_ContantTable(LPD3DXEFFECT pEffect)
{
...
CS_Skel_Archer* CS_Skel_Archer::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CS_Skel_Archer*		pGameObject = new CS_Skel_Archer(pDevice);
...
void CS_Skel_Archer::KeyCheck(void)
{

}

void CS_Skel_Archer::Sound(DWORD dwMyIndex)
{
