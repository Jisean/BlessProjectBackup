...
CSkel_Spear::CSkel_Spear(LPDIRECT3DDEVICE9 pDevice)
: CMonsters(pDevice)
, m_bPush(false)
//, m_iAniIdx(0)
{
...
CSkel_Spear::~CSkel_Spear(void)
{

}

HRESULT CSkel_Spear::Initialize(void)
{
...
_int CSkel_Spear::Update(const _float& fTimeDelta)
{
...
void CSkel_Spear::AniFrameEnd(Engine::ANI_INFO* pData)
{
...
HRESULT CSkel_Spear::AddComponent(void)
{
...
void CSkel_Spear::Set_ContantTable(LPD3DXEFFECT pEffect)
{
...
CSkel_Spear* CSkel_Spear::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CSkel_Spear*		pGameObject = new CSkel_Spear(pDevice);
...
void CSkel_Spear::KeyCheck(void)
{

}

void CSkel_Spear::Sound(DWORD dwMyIndex)
{
