...
CSoldier_1::CSoldier_1(LPDIRECT3DDEVICE9 pDevice)
: CNPCs(pDevice)
{
	
}

CSoldier_1::~CSoldier_1(void)
{

}

HRESULT CSoldier_1::Initialize(void)
{
...
_int CSoldier_1::Update(const _float& fTimeDelta)
{
	if(!m_bIninInfo)
	{
...
void CSoldier_1::AniFrameEnd(/*Engine::ANI_INFO* pData*/)
{
...
HRESULT CSoldier_1::AddComponent(void)
{
...
void CSoldier_1::Set_ContantTable(LPD3DXEFFECT pEffect)
{
...
CSoldier_1* CSoldier_1::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CSoldier_1*		pGameObject = new CSoldier_1(pDevice);
