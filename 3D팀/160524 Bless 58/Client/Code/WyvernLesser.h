...
#ifndef WyvernLesser_h__
#define WyvernLesser_h__
	...
	: public CWyverns
{
	//////////////////////////////////////////////////////////////////////////  와이번 상태값들
private:
	explicit CWyvernLesser(LPDIRECT3DDEVICE9 pDevice);
	virtual ~CWyvernLesser(void);
public:
...
public:
	static CWyvernLesser* Create(LPDIRECT3DDEVICE9 pDevice);
	virtual void Free(void);
};


#endif // WyvernLesser_h__
