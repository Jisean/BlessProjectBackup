...
#ifndef MainQStart_h__
#define MainQStart_h__
...
private:
	explicit CMainQStart(LPDIRECT3DDEVICE9 pDevice);

public:
	virtual ~CMainQStart(void);
...
public:
	static CMainQStart* Create(LPDIRECT3DDEVICE9 pDevice);
