...
CMonsterDmg::CMonsterDmg(LPDIRECT3DDEVICE9 pGraphicDev)
: CUI(pGraphicDev)
...
CMonsterDmg::~CMonsterDmg(void)
{

}

HRESULT CMonsterDmg::Initialize(const _vec3* pPos, const _float& fDmg)
{
...
_int CMonsterDmg::Update(const _float& fTimeDelta)
{
...
void CMonsterDmg::Render(void)
{
	...
	//CMonsterDmg::Set_ConstantTable(pEffect);
...
CMonsterDmg* CMonsterDmg::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* pPos, const _float& fDmg)
{
	CMonsterDmg*		pInstance = new CMonsterDmg(pGraphicDev);

	if(FAILED(pInstance->Initialize(pPos, fDmg)))
	{
		//MSG_BOX("CMonsterDmg Created Failed");
...
HRESULT CMonsterDmg::Add_Component(void)
{
	...
	pComponent = m_pTexture = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_UI, L"Texture_Font_MonsterDmg"); 
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
void CMonsterDmg::Set_ConstantTable(LPD3DXEFFECT pEffect)
{

}

void CMonsterDmg::Compute_Cnt(void)
{
	_int		iDmg = m_iDmg;
	_int		iCnt = 1;
	m_iCnt2 = 1;
