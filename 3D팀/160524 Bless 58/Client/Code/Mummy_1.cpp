...
CMummy_1::CMummy_1(LPDIRECT3DDEVICE9 pDevice)
: CMonsters(pDevice)
, m_bPush(false)
//, m_iAniIdx(0)
{
...
CMummy_1::~CMummy_1(void)
{

}

HRESULT CMummy_1::Initialize(void)
{
...
_int CMummy_1::Update(const _float& fTimeDelta)
{
...
void CMummy_1::AniFrameEnd(Engine::ANI_INFO* pData)
{
...
HRESULT CMummy_1::AddComponent(void)
{
	...
	//StaticMesh
	pComponent = Engine::Clone_Resource(RESOURCE_STAGE, L"Mesh_Mummy_1");
...
void CMummy_1::Set_ContantTable(LPD3DXEFFECT pEffect)
{
...
CMummy_1* CMummy_1::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CMummy_1*		pGameObject = new CMummy_1(pDevice);
...
void CMummy_1::KeyCheck(void)
{

}

void CMummy_1::Sound(DWORD dwMyIndex)
{
