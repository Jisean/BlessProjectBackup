...
void CLogo::Render(void)
{
	...
	Engine::Render_Font(L"¹ÙÅÁ", D3DXVECTOR3(50.f, 500.f, 0.f), m_pLoading->GetLoadMessage(), D3DXCOLOR(1.f, 1.f, 0.f, 1.f));

	/*Engine::Get_FontMgr()->Render(L"¹ÙÅÁ", D3DXVECTOR3(10, 20, 0.f), L"JusinGameAcademy", D3DXCOLOR(1.f, 0.f, 0.f, 1.f));
	Engine::Get_FontMgr()->Render(L"±¼¸²", D3DXVECTOR3(30, 50, 0.f), L"JusinGameAcademy", D3DXCOLOR(0.f, 1.f, 0.f, 1.f));
	Engine::Get_FontMgr()->Render(L"±Ã¼­", D3DXVECTOR3(50, 80, 0.f), L"JusinGameAcademy", D3DXCOLOR(0.f, 1.f, 1.f, 1.f));*/
}
