...
CGuiscardObject::CGuiscardObject(LPDIRECT3DDEVICE9 pDevice)
: CLandObject(pDevice)
, m_bCollision(false)
{
...
CGuiscardObject::~CGuiscardObject(void)
{

}

HRESULT CGuiscardObject::Initialize(const TCHAR* pMeshKey, D3DXVECTOR3 vMousePos)
{
...
int CGuiscardObject::Update(const float& fTimeDelta)
{
...
void CGuiscardObject::Render(void)
{
	if(m_bCollision)
...
HRESULT CGuiscardObject::AddComponent(const TCHAR* pMeshKey)
{
...
void CGuiscardObject::Set_ContantTable(LPD3DXEFFECT	pEffect)
{
	pEffect->AddRef();
...
CGuiscardObject* CGuiscardObject::Create(LPDIRECT3DDEVICE9 pDevice, const TCHAR* pMeshKey, D3DXVECTOR3 vMousePos)
{
	CGuiscardObject*		pGameObject = new CGuiscardObject(pDevice);
...
void CGuiscardObject::Free(void)
{
