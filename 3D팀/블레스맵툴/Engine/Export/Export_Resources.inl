...
{
	return CResourceMgr::GetInstance()->AddMesh(pDevice, wContainerIdx, eMeshType, pMeshKey, pFilePath, pFileName);
}
...
{
	CResourceMgr::GetInstance()->Delete_ByKey(wContainerIdx, wstrResourceKey);
}
