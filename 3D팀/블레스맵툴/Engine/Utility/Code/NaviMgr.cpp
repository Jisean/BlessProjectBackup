...
HRESULT Engine::CNaviMgr::Reserve_CellContainerSize(LPDIRECT3DDEVICE9 pDevice, const DWORD& dwSize)
{
...
void Engine::CNaviMgr::Unlink_Cell(void)
{
	VECCELL::iterator	iter = m_vecNaviMesh.begin();
...
int Engine::CNaviMgr::GetSize(void)
{
	return m_vecNaviMesh.size();
}

bool Engine::CNaviMgr::SetOnePoint(D3DXVECTOR3& vPoint1, D3DXVECTOR3& vPoint2, D3DXVECTOR3 vPoint3)
{
...
bool Engine::CNaviMgr::SetTwoPoint(D3DXVECTOR2 vDir, Engine::CNaviCell* pNaviClose, D3DXVECTOR3& vPoint1, D3DXVECTOR3& vPoint2)
{
...
void Engine::CNaviMgr::GetNearPoint(D3DXVECTOR3& vPoint, float fRange)
{
...
void Engine::CNaviMgr::ChangePoint(D3DXVECTOR3 vDest, D3DXVECTOR3 vSour)
{
	for(size_t i = 0; i < m_vecNaviMesh.size(); ++i)
	{
		for(int j = 0; j < CNaviCell::POINT_END; ++j)
...
void Engine::CNaviMgr::DeletePoint(D3DXVECTOR3 vDest, D3DXVECTOR3 vSour)
{
...
void Engine::CNaviMgr::DeleteTriangle(D3DXVECTOR3 vDest, D3DXVECTOR3 vSour)
{
	D3DXVECTOR3 vDist = vDest - vSour;
	if(D3DXVec3Length(&vDist) > 1.0)
		return;
...
void Engine::CNaviMgr::ResetNavimesh(void)
{
	VECCELL::iterator iter = m_vecNaviMesh.begin();
	VECCELL::iterator iter_end = m_vecNaviMesh.end();
...
void Engine::CNaviMgr::ResetIndex(void)
{
